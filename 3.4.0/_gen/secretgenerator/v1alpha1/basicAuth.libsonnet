{
  ...
  '#':: d.pkg(name='basicAuth', url='', help='"BasicAuth is the Schema for the basicauths API"'),
  ...
  '#new':: d.fn(help='new returns an instance of BasicAuth', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'secretgenerator.mittwald.de/v1alpha1',
    kind: 'BasicAuth',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BasicAuthSpec defines the desired state of BasicAuth"'),
  spec: {
